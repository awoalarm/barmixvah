function DrinkController($scope, $http) {
  ...
  $scope.addNewDrink = function () {
    ...
    $http.post('/in.json', $scope.newIng).success(function (data) {
      console.log(data.drink);
      console.log($scope);
      if (data.ing) {
  ...
  $scope.deleteDrink = function (drink) {
    console.log(drink);
    $http.post('/deletedrink.json', drink).success(function (data) {
	  alert('Drink deleted, reload page');  
      console.log("Success");
      console.log(data);
    });
  };

  $scope.deleteIngDrink = function (drink) {
    console.log(drink);
    $http.post('/deleteingdrink.json', drink).success(function (data) {
	  alert('Drink ingredient deleted, reload page');  
      console.log("Success");
      console.log(data);
    });
  };
